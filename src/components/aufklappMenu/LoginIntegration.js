...
import LogoMini2 from '../homePages/LogoMini2Cut'
    ...
    return (
            ...
            <div className={classes.integration}>
                ...
                <div onClick={loginMetamask} className={classes.walletButton}>
                    ...
                    <div style={{color:theme.font}} className={classes.buttonText}>
                        MetaMask
                    </div>
                ...
                <div style={{color:theme.font}} onClick={loginCryptoBookWallet} className={classes.walletButton}>
                    <LogoMini2 />
                    MyCryptoBook-Wallet
